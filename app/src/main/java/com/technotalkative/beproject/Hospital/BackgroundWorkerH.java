 ...
 */
public class BackgroundWorkerH extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    String usname;
    BackgroundWorkerH(Context ctx) {
        context = ctx;
    }
    @Override
    public String doInBackground(String... params) {
        ...
        String registerhp_url = "http://192.168.43.134/Hhpregister.php";
        String registerup_url="http://192.168.43.134/Hupregister.php";
            ...
            else
            {
                ...
                { try {
                    ...
                    String post_data = URLEncoder.encode("name","UTF-8")+"="+URLEncoder.encode(name,"UTF-8")+"&"
                            ...
                            +URLEncoder.encode("emailid","UTF-8")+"="+URLEncoder.encode(emailid,"UTF-8")+"&"
                            +URLEncoder.encode("phoneno","UTF-8")+"="+URLEncoder.encode(phoneno,"UTF-8")+"&"
                            +URLEncoder.encode("diseaserecord","UTF-8")+"="+URLEncoder.encode(diseaserecord,"UTF-8")+"&"
                            +URLEncoder.encode("amount","UTF-8")+"="+URLEncoder.encode(amount,"UTF-8")+"&"
