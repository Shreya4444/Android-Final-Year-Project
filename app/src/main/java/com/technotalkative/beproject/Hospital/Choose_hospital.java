...
import com.technotalkative.beproject.Hospital.List_hospital;
...
public class Choose_hospital extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState)throws InflateException {
        ...
        if(navigationView!=null) {
            ...
            TextView navUsername = (TextView) headerView.findViewById(R.id.hospusername);
        ...
        bhphospital.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                Intent i1=new Intent(Choose_hospital.this,List_hospital.class);
        ...
        buphospital.setOnClickListener(new View.OnClickListener()
        {
            ...
            @Override
            public void onClick(View v) {
                Intent i2=new Intent(Choose_hospital.this,List_hospital.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_hphospital) {
            HphospitalFragment hphospitalFragment=new HphospitalFragment();
            FragmentManager manager=getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_homeh,hphospitalFragment,hphospitalFragment.getTag()).commit();
        } else if (id == R.id.nav_uphospital) {
            UphospitalFragment uphospitalFragment=new UphospitalFragment();
            FragmentManager manager=getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_homeh,uphospitalFragment,uphospitalFragment.getTag()).commit();
        } else if (id == R.id.nav_help) {
            Helpfragment hp=new Helpfragment();
            FragmentManager manager=getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_homeh,hp,hp.getTag()).commit();
        } else if (id == R.id.nav_about) {
            Aboutfragment aboutfragment=new Aboutfragment();
            FragmentManager manager=getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_homeh,aboutfragment,aboutfragment.getTag()).commit();
        }
    ...
    public class MyTimer extends TimerTask {
        @Override
        public void run() {
            Choose_hospital.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
    ...
    public class CustomSwipeAdaptor extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            layoutInflater=(LayoutInflater)Choose_hospital.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
