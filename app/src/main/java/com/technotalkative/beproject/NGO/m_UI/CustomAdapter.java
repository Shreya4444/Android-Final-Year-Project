package com.technotalkative.beproject.NGO.m_UI;
...
import com.technotalkative.beproject.NGO.DetailActivity_ngo;
...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.model_ngo, parent, false);
        }
    ...
    private void openDetailActivity(String... details) {
        Intent i = new Intent(c, DetailActivity_ngo.class);
