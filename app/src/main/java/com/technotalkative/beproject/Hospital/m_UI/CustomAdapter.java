...
import com.technotalkative.beproject.Hospital.DetailActivity_hospital;
import com.technotalkative.beproject.R;
import com.technotalkative.beproject.Hospital.m_DataObject.Spacecraft;
...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.model_hospital, parent, false);
        }
    ...
    private void openDetailActivity(String... details) {
        Intent i = new Intent(c, DetailActivity_hospital.class);
