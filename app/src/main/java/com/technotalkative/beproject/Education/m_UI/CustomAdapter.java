package com.technotalkative.beproject.Education.m_UI;
...
import com.technotalkative.beproject.Education.DetailActivity_edu;
...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.model_edu, parent, false);
        }
    ...
    private void openDetailActivity(String... details) {
        Intent i = new Intent(c, DetailActivity_edu.class);
