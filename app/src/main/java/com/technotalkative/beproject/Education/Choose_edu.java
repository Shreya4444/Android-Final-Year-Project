...
public class Choose_edu extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState)throws InflateException {
        ...
        if(navigationView!=null) {
            ...
            TextView navUsername = (TextView) headerView.findViewById(R.id.eduusername);
        ...
        bhpeducation.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                Intent i1=new Intent(Choose_edu.this,List_edu.class);
        ...
        bupeducation.setOnClickListener(new View.OnClickListener()
        {
            ...
            @Override
            public void onClick(View v) {
                Intent i2=new Intent(Choose_edu.this,List_edu.class);
   ...
   // @SuppressWarnings("StatementWithEmptyBody")
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_hpeducation) {
            HpeducationFragment hpeducationFragment=new HpeducationFragment();
            FragmentManager manager=getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_home,hpeducationFragment,hpeducationFragment.getTag()).commit();
        } else if (id == R.id.nav_upeducation) {
            UpeducationFragment upeducationFragment=new UpeducationFragment();
            FragmentManager manager=getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_home,upeducationFragment,upeducationFragment.getTag()).commit();
        } else if (id == R.id.nav_help) {
            Helpfragment hp=new Helpfragment();
            FragmentManager manager=getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_home,hp,hp.getTag()).commit();
        } else if (id == R.id.nav_about) {
            Aboutfragment aboutfragment=new Aboutfragment();
            FragmentManager manager=getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.content_home,aboutfragment,aboutfragment.getTag()).commit();
        }
    ...
    public class MyTimer extends TimerTask {
        @Override
        public void run() {
            Choose_edu.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
    ...
    public class CustomSwipeAdaptor extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            layoutInflater=(LayoutInflater)Choose_edu.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
