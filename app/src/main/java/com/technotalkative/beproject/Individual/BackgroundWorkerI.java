 ...
 */
public class BackgroundWorkerI extends AsyncTask<String,Void,String> {
    Context context;
    String usname;
    AlertDialog alertDialog;
    BackgroundWorkerI(Context ctx) {
        context = ctx;
    }
    @Override
    public String doInBackground(String... params) {
        ...
        String registerhp_url = "http://192.168.43.134/Ihpregister.php";
        String registerup_url="http://192.168.43.134/Iupregister.php";
            ...
            else
            {
                ...
                { try {
                    ...
                    String post_data = URLEncoder.encode("name","UTF-8")+"="+URLEncoder.encode(name,"UTF-8")+"&"
                            ...
                            +URLEncoder.encode("emailid","UTF-8")+"="+URLEncoder.encode(emailid,"UTF-8")+"&"
                            +URLEncoder.encode("phoneno","UTF-8")+"="+URLEncoder.encode(phoneno,"UTF-8")+"&"
                            +URLEncoder.encode("help","UTF-8")+"="+URLEncoder.encode(website,"UTF-8")+"&"
                            +URLEncoder.encode("reason","UTF-8")+"="+URLEncoder.encode(reason,"UTF-8")+"&"
                            +URLEncoder.encode("amount","UTF-8")+"="+URLEncoder.encode(amount,"UTF-8");
                    bufferedWriter.write(post_data);
                    bufferedWriter.flush();
